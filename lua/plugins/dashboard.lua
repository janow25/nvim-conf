return {
	...
	config = function()
		...
		-- Icons replaced by actual glyphs from Nerd Font
		dashboard.section.buttons.val = {
			button("e", "  New file", ":ene <BAR> startinsert <CR>"),
			button("ff", "  Find Files"),
			button("fo", "  Recent Files"),
			button("fw", "  Find text"),
		...
		local function footer()
			...
			local value = footer_datetime .. "   Plugins " .. loaded_plugins .. "/" .. total_plugins .. nvim_version_info .. "   " .. ms .. "ms"
			return value
		end
